...
import { Home, BookOpen, CheckSquare, Calendar, GraduationCap, Sun, Moon, Clock, LogOut } from 'lucide-react';
    ...
    <header className="sticky top-0 z-50 hidden h-16 w-full items-center justify-between border-b border-slate-200/60 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md px-6 sm:flex transition-colors duration-200">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3 border-l border-slate-200 dark:border-slate-800 pl-4 ml-2">
          {/* Avatar do Usuário */}
          <div className="h-8 w-8 rounded-full bg-slate-200 dark:bg-slate-800 border-2 border-white dark:border-slate-800 shadow-sm overflow-hidden flex-shrink-0">
            <img 
